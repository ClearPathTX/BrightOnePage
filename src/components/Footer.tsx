      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid sm:grid-cols-2 gap-8 sm:gap-12">
          ...
          >
            ...
            <a
              href="tel:+1234567890"
              className="inline-flex items-center gap-3 text-[#F2EECE]/80 hover:text-[#90BB6C] transition-colors"
            >
            ...
            <div className="mt-4 sm:mt-6">
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-[#90BB6C]/20 rounded-full text-sm">
